...
export default class App extends Component {
  ...
  async loadBlockchain(){
    ...
    if (hotelContractData){
      ...
      const hotelContract = await new web3.eth.Contract(HotelContract.abi, "0xb74E4E9804765611c4B7e16e2227A016E583D835");
      ...
      window.alert("Kindly switch your network to localhost:7545");
    }
  }
